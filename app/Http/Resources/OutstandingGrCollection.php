...
class OutstandingGrCollection extends ResourceCollection
{
    public $collects = OutstandingGrResource::class;
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            'data'       => OutstandingGrResource::collection($this->collection),
            'pagination' => [
                'total'         => $this->total,
                'per_page'      => $limit,
