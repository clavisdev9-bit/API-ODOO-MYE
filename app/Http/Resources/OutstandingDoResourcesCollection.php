...
use App\Http\Resources\OutstandingDoResource;


class OutstandingDoResourcesCollection extends ResourceCollection
{
     public $collects = OutstandingDoResource::class;
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            'data' => OutstandingDoResource::collection($this->collection),
