...
class OutstandingDoWithCostResourcesCollection extends ResourceCollection
{
    public $collects = OutstandingDoWithCostResources::class;
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            'data' => OutstandingDoWithCostResources::collection($this->collection),
