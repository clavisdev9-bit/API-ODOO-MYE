...
use App\Http\Resources\OutstandingDispatchResources;

class OutstandingDispatchResourcesCollection extends ResourceCollection
{
    public $collects = OutstandingDispatchResources::class;
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            'data' => OutstandingDispatchResources::collection($this->collection),
