...
class OutstandingPiResourcesCollection extends ResourceCollection
{
    public $collects = OutstandingPiResources::class;
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            'data' => OutstandingPiResources::collection($this->collection),
